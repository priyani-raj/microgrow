...
const activityLabels = {
  dsa: { label: 'DSA Problem', color: 'bg-purple-50 text-purple-600' },
  flashcard: { label: 'Flashcards', color: 'bg-emerald-50 text-emerald-600' },
  concept: { label: 'Concept', color: 'bg-indigo-50 text-indigo-600' },
};
        ...
        {progress && (
          <>
            ...
            <div className="mt-6 rounded-xl border border-slate-200 bg-white p-5">
              ...
              {history.length === 0 ? (
                <p className="mt-2 text-sm text-slate-400">No sessions logged yet.</p>
              ) : (
